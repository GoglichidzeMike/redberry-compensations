...
describe('Check all the return values', () => {
	it('7 days, 15000 average, no tuber', () => {
	...
	it('190 days, 400 average, no tuber', () => {
	...
	it('250 days, 400 average, no tuber', () => {
